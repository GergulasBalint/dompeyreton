...
const JotForm = (props) => {
  useEffect(() => {
    var ifr = document.getElementById("JotFormIFrame-" + props.id);
    if (ifr) {
      var src = ifr.src;
      var iframeParams = [];
    ...
    window.handleIFrameMessage = function (e) {
      ...
      var iframe = document.getElementById("JotFormIFrame-" + props.id);
  ...
  return (
    <iframe
      id={"JotFormIFrame-" + props.id}
      title="Contact us"
      onload="window.parent.scrollTo(0,0)"
      allowtransparency="true"
      allowfullscreen="true"
      allow="geolocation; microphone; camera"
      src={"https://form.jotform.com/" + props.id}
      frameborder="0"
      style={{
        minWidth: "100%",
        maxWidth: "100%",
